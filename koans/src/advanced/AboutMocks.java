...
public class AboutMocks {
    ...
    static class NewExplosiveCollaborator implements Collaborator {
        public void doBusinessStuff() {  }
    }
    ...
    public void simpleAnonymousMock(){
        ...
        Collaborator newExplosiveCollaborator = new NewExplosiveCollaborator();
        new ClassUnderTest( newExplosiveCollaborator ).doSomething();
    }
